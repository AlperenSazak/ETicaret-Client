...
export class BasketsComponent extends BaseComponent implements  OnInit {
  // @ViewChild('closeBasket', { static: false }) myButton: ElementRef;
  ...
  removeBasketItem(basketItemId: string) {
    ...
    $('#closeBasketModal').trigger('click')
    this.dialogService.openDialog({
      ...
      afterClosed: async () => {
       this.showSpinner(SpinnerType.Timer);
        ...
        var a = $("." + basketItemId)
        $("." + basketItemId).fadeOut(500, () => this.hideSpinner(SpinnerType.Timer));
